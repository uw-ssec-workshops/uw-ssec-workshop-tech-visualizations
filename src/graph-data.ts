...
export const positions: Record<string, { x: number; y: number }> = {
  ...
  "iss-org": { x: 285, y: 80 },
  "iss-repo": { x: 520, y: 35 },
  "iss-team": { x: 520, y: 170 },
  "iss-onboard-management": { x: 780, y: 80 },
  "iss-onboard-public": { x: 1010, y: 140 },
  "june-org": { x: 285, y: 385 },
  "june-repo": { x: 520, y: 335 },
  "june-team": { x: 520, y: 485 },
  "june-onboard-management": { x: 780, y: 390 },
  "june-onboard-public": { x: 1010, y: 465 },
  "uw-fork-org": { x: 255, y: 690 },
  "uw-fork-repo": { x: 565, y: 690 },
  "litellm-gateway": { x: 1185, y: 305 },
  "azure-foundry": { x: 1375, y: 120 },
  "aws-bedrock": { x: 1375, y: 305 },
  "logs-db": { x: 1375, y: 515 },
  participant: { x: 80, y: 1040 },
  codespaces: { x: 635, y: 1010 },
  "codespace-secrets": { x: 635, y: 1050 },
};
